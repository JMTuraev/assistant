    ...
    <>
      ...
      <div className="min-h-screen flex flex-row   py-12 sm:px-6 lg:px-8 bg-slate-100">
        <div className="mt-8   sm:mx-auto sm:w-full sm:max-w-md   ">
          <h1 className=" text-3xl ml-4 font-bold text-indigo-600 ">
            Assistant{" "}
          </h1>
          ...
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            <div className="mt-6">
              ...
              <div className="flex flex-row space-x-6 justify-center items-center">
                ...
                <span className="whitespace-nowrap  underline underline-offset-4 cursor-pointer hover:text-indigo-600">
                  {" "}
                  праила регистрации
                </span>
              </div>
